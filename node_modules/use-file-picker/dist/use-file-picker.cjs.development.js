...
var FileSizeValidator = /*#__PURE__*/function () {
  ...
  _proto.validateBeforeParsing = function validateBeforeParsing(_config, _plainFiles) {
    return Promise.resolve();
  };

  _proto.validateAfterParsing = /*#__PURE__*/function () {
    var _validateAfterParsing = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee(config, file) {
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              return _context.abrupt("return", checkFileSize({
...
function useFilePicker(_ref) {
  ...
  var openFileSelector = function openFileSelector() {
    ...
    openFileDialog(fileExtensions, multiple, function (evt) {
      ...
      var plainFiles = inputElement.files ? Array.from(inputElement.files) : [];
