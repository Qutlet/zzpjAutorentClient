...
class App extends Component {
  render() {
    return (
      <React.Fragment>
        <Route
          render={(props) => <Navbar {...props} userdata={UserStore}></Navbar>}
        />
          ...
          <Route
            ...
            render={(props) =>
              !UserStore.isLoggedIn() ? (
                ...
                <EndOffer {...props} userdata={UserStore} />
              )
            }
          />
          <Route
            ...
            render={(props) =>
              !UserStore.isLoggedIn() ? (
                ...
                <MyRent {...props} userdata={UserStore} />
              )
            }
          />
          <Route
            ...
            render={(props) =>
              !UserStore.isLoggedIn() ? (
                ...
                <AllNoRentedOffers {...props} userdata={UserStore} />
              )
            }
          />
          ...
          <Route
            ...
            render={(props) =>
              !UserStore.isLoggedIn() ? (
                ...
                <CarList {...props} userdata={UserStore} />
              )
            }
          />
          ...
          <Route
            ...
            render={(props) =>
              !UserStore.isLoggedIn() ? (
                ...
                <AddCar {...props} userdata={UserStore} />
              )
            }
          />
          <Route
            ...
            render={(props) =>
              !UserStore.isLoggedIn() ? (
                ...
                <EditCar {...props} userdata={UserStore} />
              )
            }
          />
          <Route
            ...
            render={(props) =>
              !UserStore.isLoggedIn() ? (
                ...
                <EditOffer {...props} userdata={UserStore} />
              )
            }
          />
          <Route
            ...
            render={(props) =>
              !UserStore.isLoggedIn() ? (
                ...
                <GetAllOffers {...props} userdata={UserStore} />
              )
            }
          />
          ...
          <Route
            ...
            render={(props) =>
              !UserStore.isLoggedIn() ? (
                ...
                <AddOffer {...props} userdata={UserStore} />
              )
            }
          />
          <Route
            ...
            render={(props) =>
              !UserStore.isLoggedIn() ? (
                ...
                <MyOffers {...props} userdata={UserStore} />
              )
            }
          />
          ...
          <Route
            ...
            render={(props) =>
              !UserStore.isLoggedIn() ? (
                ...
                <Details {...props} userdata={UserStore} />
              )
            }
          />
